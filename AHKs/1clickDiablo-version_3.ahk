; this third version has removed the shadow step/dash and acts as merely an autonomous machine gun. A balance is needed between autonomous movement and uninterrupted DPS. 
...
*d::
    ...
    ; main section (beginning of combat)
	...
	k = 0
	   ...
	   k += 1
           ...
           if Mod(i,27) != 0
	   {
             ; what is going on hear is an optimized cooldown activition so arrow imbuement abilities occur as soon as possible but in the best order.
	     sendinput {a}
             if allowed = True
             {
               sendinput {b}
	     ...
	     Sleep, 40
           ...
           ; the key "q" casts the ability Puncture. we do two attacks with the dagger Condemnation to build combo points so barrage is bigger. 
           sendinput {q}
           Sleep, 40
