...
; a useful autohotkey agility bot for seer's village course in the game old school runescape. Requires Runelite Object Marker Plugin with objects colored in full with hex color #FFCF00EF. This script scans the user's computer screen from bottom to top. Thus, in-game compass should be pointed north. Randomization anti-cheat features are included to obfuscate the frequency and location of clicks. 
